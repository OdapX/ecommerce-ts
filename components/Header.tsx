...
function Header() {
  ...
  return (
    ...
    <div className=" flex  items-center justify-between py-5 space-x-5 ">
          <div className="font-bold text-3xl text-white cursor-pointer" onClick={()=>router.push('/')}>FAKESTORE</div> 
          ...
          <div className="flex items-center space-x-3 text-white">
              {session ? (<div className="hidden lg:block">
                ...
                <div className="flex items-center space-x-2 cursor-pointer" onClick={()=>router.push("/Checkout")}>
